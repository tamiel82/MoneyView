        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <a href="https://card.kbcard.com/" target="_blank" rel="noreferrer" className="flex items-center justify-between p-2.5 rounded border border-gray-100 bg-gray-50 hover:bg-blue-50 hover:text-blue-600 hover:border-blue-100 text-gray-700 transition-colors">KB국민카드 <ExternalLink size={14} /></a>
